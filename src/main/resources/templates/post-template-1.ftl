            ...
            <tr>
              <td style="background-color:#3bcdb0;">
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td>
                      <img src="${urlToImage}" style="max-width:100%; display:block;">
                    </td>
                  </tr>
                </table>
                ...
                <tr>
                  ...
                  <br>
                    <div><!--[if mso]>
                      ...
                      <![endif]-->
                          <a href="http://"
                        style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Source</a>
                          <!--[if mso]>
                        </center>
                      </v:rect>
                    <![endif]--></div>
              ...
              <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                <tr>
                  <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                    © Mboot - 2020 All Rights Reserved
                  </td>
                </tr>
